 ...
 * File Name: Home.jsx
 *
 * Description: This is the home page for the student aspect of the app. It contains a quick introduction to the app along with things
 * the student can do.
 *
 */
...
class Home extends Component {
  ...
  render() {
    // Getting the firstname and lastname of the student from the cookies.
    const firstname = Cookies.get("firstname");
    const lastname = Cookies.get("lastname");

    // Displaying a welcome message and introduction to the student.
    return (
      <div>
        <div className="row">
        ...
        <div className="row">
          <div className="col s12">
            ...
            <p>
              This is the student area of the MyGrade app. Here you have various
              functionality available to you. To navigate the site use the menu
              icon available at the bottom right of the screen.
            </p>
            <p>What you can do as a student: </p>
            <ul className="collection">
              <li className="collection-item">View Assignments</li>
              <li className="collection-item">Upload Assignment</li>
              <li className="collection-item">View Feedback</li>
              <li className="collection-item">Download Feedback</li>
              <li className="collection-item">View Uploads</li>
              <li className="collection-item">Delete Uploads</li>
